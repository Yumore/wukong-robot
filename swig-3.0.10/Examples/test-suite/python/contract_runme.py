...
try:
    ...
    print
    "Failed! Preassertions are broken"
except:
    pass
...
try:
    contract.test_postassert(-3)
    print
    "Failed! Postassertions are broken"
except:
    pass
...
try:
    ...
    print
    "Failed! Static method preassertion"
except:
    pass
...
try:
    ...
    print
    "Failed! Static method posteassertion"
except:
    pass
...
try:
    d.foo(-1, 1, 1, 1, 1)
    print
    "Failed! Inherited preassertion (D)."
except:
    pass
try:
    d.foo(1, -1, 1, 1, 1)
...
try:
    ...
    print
    "Failed! constructor preassertion"
except:
    pass
